                ...
                <div class="grid">
                    <div class="grid__row app__content">
                        ...
                        <div class="header__search">
                            ...
                            <input type="text" class="header__search-input" placeholder="Nhập để tìm kiếm" onkeyup="getProductInfo(this.value)">
...
function getProductInfo(productCode) {
    ...
    if (productCode !== "") {
        ...
        if (filteredProducts.length > 0) {
            ...
            productInfoDiv.innerText = "Không tìm thấy thông tin sản phẩm.";
        }
    }
}

// Lấy thông tin sản phẩm từ PHP và lưu vào biến products
