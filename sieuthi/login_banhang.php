...
if (isset($_POST['btn-login'])) {
    ...
    $sql = "SELECT  Email,SDT, mk FROM nhanvien WHERE (Email='$tk' OR SDT='$tk') AND mk='$mk'";
    ...
    if (mysqli_num_rows($kq) > 0) {
        ...
        header("location: login_banhang.php");
        exit;
    }
    ...
    if ($matkhauMoi === $xacNhanMatKhauMoi) {
        ...
        $sql9 = "UPDATE nhanvien SET mk='$matkhauMoi' WHERE Email='$email'";
